...
type TcpSliceRouterHandler struct {
	coreFunc func(routerContext *TcpSliceRouterContext) tcp_server.TCPHandler
...
func NewTcpSliceRouterHandler(coreFunc func(routerContext *TcpSliceRouterContext) tcp_server.TCPHandler, router *TcpSliceRouter) *TcpSliceRouterHandler {
